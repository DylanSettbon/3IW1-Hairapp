...
<main>
    <div class="row slideshow-container">
        ...
        <div class="mySlides fade">
            <img class="contain-img" alt="Hairapp" src="../public/img/fushimi-inari-taisha-shrine-kyoto-japan-temple-161401 (1).jpeg" style="width:100%">
        ...
        <div class="mySlides fade">
            <img class="contain-img" alt="Voir les forfaits" src="../public/img/pexels-photo-127578.jpeg" style="width:100%">
            <diV class="text-image">
                <h1 class="text-image-h1">Prendre rendez-vous</h1>
                <h2 class="text-image-h2">Prenez directement rendez-vous avec votre salon en ligne</h2>
                <a href="<?php echo DIRNAME; ?>appointment/getAppointment">Cliquez ici</a>
        ...
        <div class="mySlides fade">
            <img class="contain-img" alt="Prendre rendez-vous" src="../public/img/pexels-photo-96931.jpeg" style="width:100%">
            <diV class="text-image">
                <h1 class="text-image-h1">Prendre rendez-vous</h1>
                <h2 class="text-image-h2">Prenez directement rendez-vous avec votre salon en ligne</h2>
                <a href="<?php echo DIRNAME; ?>appointment/getAppointment">Cliquez ici</a>
    ...
    <section class="col-s-12 col-m-12 col-l-4 forfait-accueil">
        <h2 class="title-carte" style="margin-right: 35px;">Découvrez notre carte</h2>
                ...
                <span>
                    ...
                    <img alt="barber" class="contain-img" src="../public/img/pexels-photo-127578.jpeg" style="width:100%; padding:10px">
                </span>
