                    ...
                    <div class="col-s-12 col-m-6 col-l-6 center">
                        <div class="form_register">
                            ...
                            <form method="post" action="<?php echo DIRNAME;?>signin/validate">
                                ...
                                <input class="input_sign-in" type="email" name="emailConfirm" placeholder="Confirmation de l'email">
                                <input class="input_sign-in" type="password" name="pwd" placeholder="Mot de passe"   />
                                <input class="input_sign-in" type="password" name="pwdConfirm" placeholder="Confirmation du mot de passe">
